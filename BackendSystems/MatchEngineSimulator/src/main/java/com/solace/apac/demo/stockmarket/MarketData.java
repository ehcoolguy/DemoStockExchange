...
public class MarketData {
    private long orderId;  //整個交易引擎的序號
    private long symbolOrderId;  //目前這檔個股的交易序號
    private String id;
    ...
    private boolean isBuyPrice;  //是否為外盤價成交
    private Date tradeDateTime;  //成交時間
    private long lastUpdated;  //最後更新時間
    private boolean isSnapshot;  //是否為snapshot
